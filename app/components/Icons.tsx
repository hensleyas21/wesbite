...
export function GitHub(props: IIconProps) {
...
export function Resume(props: IIconProps) {
  const { className } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function Database(props: IIconProps) {
  const { className } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function AWS(props: IIconProps) {
  const { className } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function Book(props: IIconProps) {
  const { className } = props;
...
export function Dot(props: IIconProps) {
  const { className } = props;
